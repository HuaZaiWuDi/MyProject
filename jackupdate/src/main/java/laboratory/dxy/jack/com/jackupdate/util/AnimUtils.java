...
public class AnimUtils {
     ...
     * @param duration 时间
     */
    public static void doRotateAnim(View view, final int duration) {

        AnimatorSet set = new AnimatorSet();
        set.playTogether(
                ObjectAnimator.ofFloat(view, "rotationX", 1.0f, 0f, 1f),
                ObjectAnimator.ofFloat(view, "rotationY", 1.0f, 0f, 1f)
        );
        set.setDuration(duration);
