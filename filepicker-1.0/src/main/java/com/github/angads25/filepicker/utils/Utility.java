...
public class Utility {
    ...
    public static String getFileSizeText(File file)
    {
        ...
        if (length < 1024)
        {
            sizeText = length + "Bytes";
        }
        else if (length < 1024*1024)
        {
            sizeText = mDecimalFormat.format(length/1024f) + "K";
        }else if (length < 1024*1024*1024)
        {
            sizeText = mDecimalFormat.format(length/(1024*1024f)) + "M";
        }
        else if (length < 1024*1024*1024*1024)
        {
            sizeText = mDecimalFormat.format(length/(1024*1024*1024f)) + "G";
        }
