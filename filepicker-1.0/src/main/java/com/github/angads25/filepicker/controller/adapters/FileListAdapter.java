...
//        }
        if (item.isDirectory()) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                holder.type_icon.setColorFilter(context.getResources().getColor(R.color.colorGreen, context.getTheme()));
            } else {
                holder.type_icon.setColorFilter(context.getResources().getColor(R.color.colorGreen));
            }
...
//            Log.d("SYD", "item.getLocation(): " + item.getLocation());
            holder.type.setText(sdate.format(date) + ", " + stime.format(date) + " " + Utility.getFileSizeText(new File(item.getLocation())));
        }
        ...
        holder.fmark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (previousCheckedPosition != -1){
                    listItem.get(previousCheckedPosition).setMarked(false);
                }
